...
class PythonOrgSearchChrome(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Hack because for using OS X. On Windows or Linux you could just specify these as a ChromeOption
    ...
    def tearDown(self):
        # Close the browser.
        # Note close() will close the current tab, if its the last tab it will close the browser.
        # To close the browser entirely use quit()
        self.driver.close()
...
class PythonOrgSearchFireFox(unittest.TestCase):
    def setUp(self):
        ...
        # Window management hacks because I'm using OS X.
        # On Windows or Linux you could just specify these as webdriver options
        self.driver.set_window_size(1920, 1080)
        self.driver.maximize_window()
